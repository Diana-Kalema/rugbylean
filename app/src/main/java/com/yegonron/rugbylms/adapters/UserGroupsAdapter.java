...
import com.yegonron.rugbylms.User;
import com.yegonron.rugbylms.UserAdapter;
...
public class UserGroupsAdapter extends RecyclerView.Adapter<UserGroupsAdapter.UserGroupsAdapterViewHolder>{
    ...
    @NonNull
    @Override
    public UserGroupsAdapter.UserGroupsAdapterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull UserGroupsAdapter.UserGroupsAdapterViewHolder holder, int position) {
        ...
        public UserGroupsAdapterViewHolder(@NonNull View itemView) {
            ...
            cardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    switchVisibility(groupName,cardView,imageView,linearLayout,layout,userGroupList.get(getAdapterPosition()),database,context);
                }
            });
        }
    }
